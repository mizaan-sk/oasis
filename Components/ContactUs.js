...
export default function ContactForm({ countryFromURL }) {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    ...
    try {
      await fetch(
        "https://script.google.com/macros/s/AKfycbypUIFJmr_cmUxVaAQ12fEl6eglnrU04H0vl86UTsVpoZcmnSZU6iST1Ptn0bzXZIkAUw/exec",
        {
          method: "POST",
...
UTM Keywords: ${utm_keyword || ""}`,
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('/assets/oas_bg6.webp')" }}
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-white px-4 py-12 md:py-16">
        <div className="text-center mb-8">
          ...
          <p className="text-sm md:text-base font-extralight">
            Please Enter Your Details To Know More About Oasis Properties.
          </p>
        </div>
